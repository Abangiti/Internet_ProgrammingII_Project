  ...
  return (
    ...
    <header>
      <section className="service_head">
        <h1 className="service">Birthday Services</h1>
      </section>
    </header>
      ...
      <div className="services">
        <div className="decor">
          ...
          <div className="box-container">
            <div className="box">
              <img
                src="../Resources/Images/birthday/decor1.jpg"
                alt="Burger Image"
              />
            ...
            <div className="box">
              <img
                src="../Resources/Images/birthday/decor2.jpg"
                alt="Pizza Image"
              />
            ...
            <div className="box">
              <img
                src="../Resources/Images/birthday/decor3.jpg"
                alt="Special Image"
              />
        ...
        <div className="catering">
          ...
          <div className="box-container">
            <div className="box">
              <img
                src="../Resources/Images/birthday/catering1.jpg"
                alt="flavor fusion"
              />
              <h2>FlavorFusion</h2>
              <div className="rating">
            ...
            <div className="box">
              <img
                src="../Resources/Images/birthday/catering2.jpg"
                alt="Pizza Image"
              />
            ...
            <div className="box">
              <img
                src="../Resources/Images/birthday/catering3.jpg"
                alt="Special Image"
              />
        ...
        <div className="makeup">
          ...
          <div className="box-container">
            <div className="box">
              <img src="../Resources/Images/birthday/makeup1.jpg" alt="Disney" />
            ...
            <div className="box">
              <img src="../Resources/Images/birthday/makeup2.jpg" alt="Petite" />
            ...
            <div className="box">
              <img
                src="../Resources/Images/birthday/makeup3.jpg"
                alt="Sweet beauty"
              />
              <h2>Sweet beauty</h2>
              <div className="rating">
        ...
        <div className="bakery">
          ...
          <div className="box-container">
            <div className="box">
              <img
                src="../Resources/Images/birthday/cake1.jpg"
            ...
            <div className="box">
              <img
                src="../Resources/Images/birthday/cake2.jpg"
                alt="Pizza Image"
              />
            ...
            <div className="box">
              <img
                src="../Resources/Images/birthday/cake3.jpg"
                alt="Special Image"
              />
        ...
        <div className="photography">
          ...
          <div className="box-container">
            <div className="box">
              <img
                src="../Resources/Images/birthday/photo1.jpg"
                alt="Burger Image"
              />
            ...
            <div className="box">
              <img
                src="../Resources/Images/birthday/photo2.jpg"
                alt="Pizza Image"
              />
            ...
            <div className="box">
              <img
                src="../Resources/Images/birthday/photo3.jpg"
                alt="Special Image"
              />
